...
**Built with ❤️ using modern web technologies** hết! Còn 500,000đ (10%)",
          "data": {
            "budgetId": "...",
            "spent": 4500000,
            "limit": 5000000,
...
| Method | Endpoint                  | Description                       | Auth Required |
| ------ | ------------------------- | --------------------------------- | ------------- |
| GET    | `/api/analytics/overview` | Get income, expenses, savings     | ✅            |
| GET    | `/api/analytics/category` | Get spending breakdown by category| ✅            |
| GET    | `/api/analytics/trends`   | Get monthly spending trends       | ✅            |

**Query Parameters:**
- `startDate`, `endDate` – Date range for analysis
- `period` – Group by `day`, `week`, `month`, or `year`
...
| Method | Endpoint          | Description                                | Auth Required |
| ------ | ----------------- | ------------------------------------------ | ------------- |
| POST   | `/api/ai/chat`    | Chat with AI about your finances           | ✅            |
| POST   | `/api/ai/analyze` | Get AI-powered spending analysis           | ✅            |

**Powered by OpenAI via OpenRouter** – Ask questions like:
...
Visit **http://localhost:4000/api-docs** for full Swagger UI documentation with:
- Try-it-out functionality
- Request/response schemas
- Authentication testing | Monthly income, expenses, savings |
